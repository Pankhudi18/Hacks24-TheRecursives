  ...
  return (
    <View style={{ flex: 1, }}>
      ...
      <View style={{ flex: 1, justifyContent: 'flex-end' }}>
        <TouchableOpacity onPress={schduleNotification} style={{ height: Utils.ScreenHeight(7), width: '80%', alignSelf: 'center', justifyContent: 'center', alignItems: 'center', backgroundColor: colors.primary, marginVertical: Utils.ScreenHeight(2), borderRadius: 5 }}>
