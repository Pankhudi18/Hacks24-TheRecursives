            ...
            <View style={{ height: "100%", backgroundColor: colors.white }}>
                ...
                <ScrollView >
                    ...
                    <View style={{ marginHorizontal: Utils.ScreenWidth(5) }}>
                        <TouchableOpacity onPress={() => {navigation.navigate("Dashboard")}} style={{ borderWidth: 0.5, marginTop: Utils.ScreenHeight(2), borderColor: colors.grey2, borderRadius: 6, height: Utils.ScreenHeight(6), justifyContent: "center" }} >
                            <View style={{ flexDirection: "row", alignItems: "center", marginHorizontal: Utils.ScreenWidth(4), justifyContent: "space-between" }}>
                                <Text style={{ color: colors.black, fontWeight: '400', fontSize: 16 }}>Dashboard</Text>
