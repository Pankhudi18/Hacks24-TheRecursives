...
function LoginDesigner(props) {
    ...
    const signInApi = () => {
        ...
        // formdata.append('acname="Logoutclient" component={Logoutclient} />n', 'login');
        const body ={
            "mobile_no": number,
            // "action":   "login",
        }
    ...
    return (
        <SafeAreaView style={styles.container}>
                ...
                <View style={styles.boxCss}>
                    <View style={{ marginTop: Utils.ScreenWidth(9), marginHorizontal: Utils.ScreenWidth(4.5), }}>
                        <View style={{ marginTop: Utils.ScreenHeight(2), marginLeft: Utils.ScreenWidth(2) }}>
                            <Text style={{ color: 'black', fontWeight: '600', fontSize: 16 }}>login with Phone</Text>
                        </View>
            ...
            {navigation.navigate("VerifyotpDoctor",{phno:number})}}><Text></Text></TouchableOpacity>
